package com.aihook.wheelpickerview.library.view;

import android.view.View;

import com.aihook.wheelpickerview.library.R;
import com.aihook.wheelpickerview.library.adapter.ArrayWheelAdapter;
import com.aihook.wheelpickerview.library.lib.WheelView;
import com.aihook.wheelpickerview.library.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
    ...
    private ArrayList<T> mOptionsItems1;
    private ArrayList<T> mOptionsItems2;
    private ArrayList<T> mOptionsItems3;
    ...
    public void setPickerNoLinkage(ArrayList<T> optionsItems1, ArrayList<T> optionsItems2){
        setPickerNoLinkage(optionsItems1, optionsItems2, null);
    }

    public void setPickerNoLinkage(ArrayList<T> optionsItems1, ArrayList<T> optionsItems2, ArrayList<T> optionsItems3){
        this.mOptionsItems1 = optionsItems1;
        this.mOptionsItems2 = optionsItems2;
        this.mOptionsItems3 = optionsItems3;
        int len = ArrayWheelAdapter.DEFAULT_LENGTH;
        if (this.mOptionsItems3 == null)
            len = 8;
        if (this.mOptionsItems2 == null)
            len = 12;
        // 选项1
        wv_option1 = (WheelView) view.findViewById(R.id.options1);
        wv_option1.setAdapter(new ArrayWheelAdapter(mOptionsItems1, len));// 设置显示数据
        wv_option1.setCurrentItem(0);// 初始化时显示的数据
        // 选项2
        wv_option2 = (WheelView) view.findViewById(R.id.options2);
        if (mOptionsItems2 != null)
            wv_option2.setAdapter(new ArrayWheelAdapter(mOptionsItems2));// 设置显示数据
        wv_option2.setCurrentItem(0);// 初始化时显示的数据
        // 选项3
        wv_option3 = (WheelView) view.findViewById(R.id.options3);
        if (mOptionsItems3 != null)
            wv_option3.setAdapter(new ArrayWheelAdapter(mOptionsItems3));// 设置显示数据
