package com.aihook.wheelpickerview.library;
...
import com.aihook.wheelpickerview.library.view.BasePickerView;
import com.aihook.wheelpickerview.library.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public void setPickerNoLinkage(ArrayList<T> optionsItems1, ArrayList<T> optionsItems2) {
        wheelOptions.setPickerNoLinkage(optionsItems1, optionsItems2, null);
    }

    public void setPickerNoLinkage(ArrayList<T> optionsItems1, ArrayList<T> optionsItems2, ArrayList<T> optionsItems3) {
        wheelOptions.setPickerNoLinkage(optionsItems1, optionsItems2, optionsItems3);
    }
